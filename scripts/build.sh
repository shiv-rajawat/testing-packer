...
terraform apply -var "region=${AWS_REGION}" -var "access_key=$AWS_ACCESS_KEY_ID" -var "secret_key=$AWS_SECRET_ACCESS_KEY" -var-file=../parameters/pre-elk-param.tfvars -auto-approve
